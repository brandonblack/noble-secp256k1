...
class AbstractBPSJ {
    ...
    recover() {
        ...
        let t5 = mod(this.T[3] ** _2n);
        t5 = mod(t5 * BigInt(4));
        const t6 = mod(t5 * this.T[2]);
...
class BPSJ8 extends AbstractBPSJ {
    ...
    ladd(b) {
        ...
        let t5 = mod(this.T[4] * this.T[2 + b]);
        t5 = mod(this.T[1] + t5);
        let t6 = mod(t5 * this.T[3 - b]);
        const t7 = mod(t5 ** _2n);
        t5 = mod(this.T[4] * t6);
        t5 = mod(t7 + t5);
        ...
        this.T[4] = mod(this.T[3 - b] - t5);
        this.T[3 - b] = mod(t7 * t5);
        t5 = half(this.T[4]);
        t6 = mod(t5 ** _2n);
        t6 = mod(t6 - this.T[0]);
