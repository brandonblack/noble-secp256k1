...
exports.utils = exports.schnorr = exports.verify = exports.signSync = exports.sign = exports.getSharedSecret = exports.recoverPublicKey = exports.getPublicKey = exports.Signature = exports.Point = exports.BPSJ9 = exports.BPSJ8 = exports.CURVE = void 0;
...
class AbstractBPSJ {
    constructor(P) {
        this.P = P;
        this.T = [_0n, _0n, _0n, _0n, _0n, _0n];
    }
    multiply(scalar) {
        if (scalar === _0n)
            return Point.ZERO;
        if (scalar === _1n)
            return this.P;
        if (scalar < _1n || scalar >= CURVE.P - _1n)
            throw new Error("Expecting scalar between 2 and P - 1");
    ...
    recover() {
        this.T[3] = mod(this.P.y * this.T[0]);
        this.T[5] = mod(this.T[3] ** _2n);
        this.T[5] = mod(this.T[5] * BigInt(4));
        const t6 = mod(this.T[5] * this.T[2]);
        this.T[0] = mod(t6 * this.T[4]);
        const t7 = mod(this.T[0] * this.T[3]);
        this.T[0] = mod(this.P.x * this.T[1]);
        this.T[1] = mod(this.T[0] ** _2n);
        this.T[3] = mod(this.T[1] * this.T[0]);
        this.T[1] = mod(this.T[3] * BigInt(27));
        this.T[4] = invert(this.T[1]);
        this.T[1] = mod(this.T[4] * t7);
        this.T[1] = mod(this.T[1] + this.P.y);
        this.T[3] = mod(this.T[4] * this.T[0]);
        this.T[5] = mod(this.T[3] * BigInt(3));
        this.T[0] = mod(this.T[5] * t6);
        this.T[0] = mod(this.T[0] + this.P.x);
        return [this.T[0], this.T[1]];
    }
}
class BPSJ8 extends AbstractBPSJ {
    setup() {
        this.T[5] = mod(this.P.y ** _2n);
        this.T[2] = mod(this.P.x * this.T[5]);
        this.T[0] = mod(this.T[2] * BigInt(12));
        this.T[2] = mod(this.P.x ** _2n);
        this.T[4] = mod(this.T[2] * BigInt(3));
        this.T[2] = mod(this.T[4] + CURVE.a);
        this.T[4] = mod(this.T[2] + this.T[2]);
        this.T[3] = mod(this.T[2] ** _2n);
        this.T[2] = mod(this.T[5] ** _2n);
        this.T[3] = mod(this.T[3] - this.T[0]);
        this.T[1] = mod(this.T[2] * BigInt(16));
        this.T[2] = _0n;
    }
    ladd(b) {
        this.T[3 - b] = mod(this.T[3 - b] - this.T[2 + b]);
        this.T[5] = mod(this.T[4] * this.T[2 + b]);
        this.T[5] = mod(this.T[1] + this.T[5]);
        let t6 = mod(this.T[5] * this.T[3 - b]);
        const t7 = mod(this.T[5] ** _2n);
        this.T[5] = mod(this.T[4] * t6);
        this.T[5] = mod(t7 + this.T[5]);
        this.T[4] = mod(this.T[1] * t6);
        this.T[1] = mod(t6 ** _2n);
        this.T[0] = mod(this.T[0] * this.T[1]);
        this.T[1] = mod(this.T[4] * this.T[1]);
        t6 = mod(this.T[3 - b] ** _2n);
        this.T[3 - b] = mod(this.T[2 + b] * t6);
        this.T[3 - b] = mod(this.T[3 - b] + this.T[3 - b]);
        this.T[3 - b] = mod(this.T[3 - b] - t7);
        this.T[4] = mod(this.T[3 - b] - this.T[5]);
        this.T[3 - b] = mod(t7 * this.T[5]);
        this.T[5] = half(this.T[4]);
        t6 = mod(this.T[5] ** _2n);
        t6 = mod(t6 - this.T[0]);
        this.T[2 + b] = mod(t6 - this.T[3 - b]);
    }
}
exports.BPSJ8 = BPSJ8;
class BPSJ9 extends AbstractBPSJ {
    setup() {
        this.T[5] = mod(this.P.y ** _2n);
        this.T[2] = mod(this.P.x * this.T[5]);
        this.T[0] = mod(this.T[2] * BigInt(12));
    ...
    ladd(b) {
        let t6, t7;
        this.T[3 - b] = mod(this.T[3 - b] - this.T[2 + b]);
        t6 = mod(this.T[4] * this.T[2 + b]);
        t6 = mod(this.T[1] + t6);
        t7 = mod(t6 + this.T[3 - b]);
        const t8 = mod(this.T[3 - b] ** _2n);
        this.T[3 - b] = mod(t7 ** _2n);
        t7 = mod(t6 ** _2n);
        t6 = mod(this.T[3 - b] - t7 - t8);
        t6 = half(t6);
        this.T[3 - b] = mod(this.T[1] * t6);
        this.T[1] = mod(t6 ** _2n);
        this.T[4] = mod(this.T[4] + t6);
        this.T[0] = mod(this.T[0] * this.T[1]);
        t6 = mod(this.T[4] ** _2n);
        t6 = mod(t6 - this.T[1]);
        this.T[4] = half(t6);
        this.T[4] = mod(t7 + this.T[4] - _2n * this.T[5]);
        this.T[1] = mod(this.T[3 - b] * this.T[1]);
        this.T[5] = mod(this.T[2 + b] * t8);
        this.T[3 - b] = mod(t7 * this.T[4]);
        this.T[4] = mod(_2n * this.T[5] - this.T[4] - t7);
        t6 = half(this.T[4]);
        this.T[5] = mod(t6 ** _2n);
        this.T[2 + b] = mod(this.T[5] - this.T[0] - this.T[3 - b]);
    }
}
exports.BPSJ9 = BPSJ9;
class Point {
