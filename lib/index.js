...
exports.utils = exports.schnorr = exports.verify = exports.signSync = exports.sign = exports.getSharedSecret = exports.recoverPublicKey = exports.getPublicKey = exports.Signature = exports.Point = exports.BPSJ2Rand = exports.BPSJ2 = exports.BPSJ = exports.CURVE = void 0;
...
exports.BPSJ = BPSJ;
class BPSJ2 extends AbstractBPSJ {
    setup(b) {
        this.T[0] = this.P.x;
        this.T[1] = this.P.y;
        do {
            this.T[2] = bytesToNumber(exports.utils.randomBytes());
...
exports.BPSJ2 = BPSJ2;
class BPSJ2Rand extends AbstractBPSJ {
    constructor(P) {
        super(P);
        const randomBits = bitGen(exports.utils.randomBytes(65));
