...
exports.utils = exports.schnorr = exports.verify = exports.signSync = exports.sign = exports.getSharedSecret = exports.recoverPublicKey = exports.getPublicKey = exports.Signature = exports.Point = exports.BPSJ8 = exports.CURVE = void 0;
...
class BPSJ8 {
    ...
    setup() {
        const t5 = (this.P.y ** _2n) % CURVE.P;
        this.T[2] = (this.P.x * t5) % CURVE.P;
        this.T[0] = (this.T[2] * BigInt(12)) % CURVE.P;
        this.T[2] = (this.P.x ** _2n) % CURVE.P;
        this.T[4] = (this.T[2] * BigInt(3)) % CURVE.P;
        this.T[2] = (this.T[4] + CURVE.a) % CURVE.P;
        this.T[4] = (_2n * this.T[2]) % CURVE.P;
        this.T[3] = (this.T[2] ** _2n) % CURVE.P;
        this.T[2] = (t5 ** _2n) % CURVE.P;
        this.T[3] = mod(this.T[3] - this.T[0]);
        this.T[1] = (this.T[2] * BigInt(16)) % CURVE.P;
        this.T[2] = _0n;
    }
    ladd(b) {
        this.T[3 - b] = mod(this.T[3 - b] - this.T[2 + b]);
        let t5 = (this.T[4] * this.T[2 + b]) % CURVE.P;
        t5 = (this.T[1] + t5) % CURVE.P;
        let t6 = (t5 * this.T[3 - b]) % CURVE.P;
        const t7 = (t5 ** _2n) % CURVE.P;
        t5 = (this.T[4] * t6) % CURVE.P;
        t5 = (t7 + t5) % CURVE.P;
        this.T[4] = (this.T[1] * t6) % CURVE.P;
        this.T[1] = (t6 ** _2n) % CURVE.P;
        this.T[0] = (this.T[0] * this.T[1]) % CURVE.P;
        this.T[1] = (this.T[4] * this.T[1]) % CURVE.P;
        t6 = (this.T[3 - b] ** _2n) % CURVE.P;
        this.T[4] = (this.T[2 + b] * t6) % CURVE.P;
        this.T[4] = mod(this.T[4] - t7 + this.T[4] - t5);
        this.T[3 - b] = (t7 * t5) % CURVE.P;
        t6 = this.T[4];
        t6 = ((t6 & _1n) ? (t6 + CURVE.P) : t6) >> _1n;
        t6 = (t6 ** _2n) % CURVE.P;
        this.T[2 + b] = mod(t6 - this.T[0] - this.T[3 - b]);
    }
    recover() {
        this.T[3] = (this.P.y * this.T[0]) % CURVE.P;
        let t5 = (this.T[3] ** _2n) % CURVE.P;
        t5 = (t5 * BigInt(4)) % CURVE.P;
        const t6 = (t5 * this.T[2]) % CURVE.P;
        this.T[0] = (t6 * this.T[4]) % CURVE.P;
        const t7 = (this.T[0] * this.T[3]) % CURVE.P;
        this.T[0] = (this.P.x * this.T[4]) % CURVE.P;
        this.T[1] = (this.T[0] ** _2n) % CURVE.P;
        this.T[3] = (this.T[1] * this.T[0]) % CURVE.P;
        this.T[1] = (this.T[3] * BigInt(27)) % CURVE.P;
        this.T[4] = invert(this.T[1]);
        this.T[1] = (this.T[4] * t7) % CURVE.P;
        this.T[1] = (this.T[1] + this.P.y) % CURVE.P;
        this.T[3] = (this.T[4] * this.T[0]) % CURVE.P;
        t5 = (this.T[3] * BigInt(3)) % CURVE.P;
        this.T[0] = (t5 * t6) % CURVE.P;
        this.T[0] = (this.T[0] + this.P.x) % CURVE.P;
