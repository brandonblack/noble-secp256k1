...
class BPSJ8 {
    ...
    setup() {
        ...
        const t5 = (this.P.y ** _2n) % ord;
        this.T[2] = (this.P.x * t5) % ord;
        this.T[0] = (this.T[2] * BigInt(12)) % ord;
        this.T[2] = (this.P.x ** _2n) % ord;
        this.T[4] = (this.T[2] * BigInt(3)) % ord;
        this.T[2] = (this.T[4] + alpha) % ord;
        this.T[4] = (_2n * this.T[2]) % ord;
        this.T[3] = (this.T[2] ** _2n) % ord;
        this.T[2] = (t5 ** _2n) % ord;
        this.T[3] = mod(this.T[3] - this.T[0]);
        this.T[1] = (this.T[2] * BigInt(16)) % ord;
        this.T[2] = _0n;
    }
    ladd(b) {
        const { P: ord } = CURVE;
        this.T[3 - b] = mod(this.T[3 - b] - this.T[2 + b]);
        let t5 = (this.T[4] * this.T[2 + b]) % ord;
        t5 = (this.T[1] + t5) % ord;
        let t6 = (t5 * this.T[3 - b]) % ord;
        const t7 = (t5 ** _2n) % ord;
        t5 = (this.T[4] * t6) % ord;
        t5 = (t7 + t5) % ord;
        this.T[4] = (this.T[1] * t6) % ord;
        this.T[1] = (t6 ** _2n) % ord;
        this.T[0] = (this.T[0] * this.T[1]) % ord;
        this.T[1] = (this.T[4] * this.T[1]) % ord;
        t6 = (this.T[3 - b] ** _2n) % ord;
        this.T[4] = (this.T[2 + b] * t6) % ord;
        this.T[4] = mod(this.T[4] - t7 + this.T[4] - t5);
        this.T[3 - b] = (t7 * t5) % ord;
        t6 = this.T[4];
    ...
    recover() {
        const { P: ord } = CURVE;
        this.T[3] = (this.P.y * this.T[0]) % ord;
        let t5 = (this.T[3] ** _2n) % ord;
        t5 = (t5 * BigInt(4)) % ord;
        const t6 = (t5 * this.T[2]) % ord;
        this.T[0] = (t6 * this.T[4]) % ord;
        const t7 = (this.T[0] * this.T[3]) % ord;
        this.T[0] = (this.P.x * this.T[1]) % ord;
        this.T[1] = (this.T[0] ** _2n) % ord;
        this.T[3] = (this.T[1] * this.T[0]) % ord;
        this.T[1] = (this.T[3] * BigInt(27)) % ord;
        this.T[4] = invert(this.T[1]);
        this.T[1] = (this.T[4] * t7) % ord;
        this.T[1] = (this.T[1] + this.P.y) % ord;
        this.T[3] = (this.T[4] * this.T[0]) % ord;
        t5 = (this.T[3] * BigInt(3)) % ord;
        this.T[0] = (t5 * t6) % ord;
        this.T[0] = (this.T[0] + this.P.x) % ord;
